...
可以先照抄，後續熟悉了再依照自己習慣調整。 ~~預設尤其手把實在太難用了~~
...
* 雇員物品欄顯示類型 → 改為 **<span style="color: #ff4757; font-weight: bold;">展開</span>**<br>
  包包是由4個分頁組成，全展開才能一次看到四個頁面的內容。
* <span style="color: #1890ff;">⬜ ☐ 獲得裝備時自動收納到兵裝庫中</span>
  包包有分為一般包包和只能放裝備的兵裝庫<br>
  如果職業練很多的話可能會有每個職業*不同等級的裝備把兵裝庫塞滿<br>
  取消之後把需要的在自己放入兵裝庫能比較有效的利用空間<br>
* ✅ 獲得物品前後往前收納<br>
  方便辨別新獲得物品的位置。
...
* <span style="color: #1890ff;">☐推薦任務</span><br>
  登入跳出的推薦任務，通常都是你附近的支線，應該也沒人會看吧...?<br>
* <span style="color: #fa541890ff1c;">☐資訊中心</span><br>
  沒什麼用的公告<br>
* <span style="color: #1890ff;">☐成就</span><br>
  就...成就，看個人需求開啟<br>
